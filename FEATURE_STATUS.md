...
| Satellite imagery context | **Implemented visual only** | NASA GIBS/Esri can be displayed as basemaps; no inference is implied. |
| Landslide4Sense segmentation | **Deferred roadmap** | Correctly scoped as post-event inventory mapping; no trained scene pipeline bundled. |
